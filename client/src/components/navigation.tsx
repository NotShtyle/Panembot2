    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 rounded-full gradient-bg-orange-yellow flex items-center justify-center animate-pulse-slow">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Button 
                ...
                className="gradient-bg-orange-yellow text-dark-primary px-6 py-2 rounded-full font-semibold hover:scale-105 transform transition-all duration-300 shadow-lg hover:shadow-orange-primary/25"
      ...
      >
        <div className="flex flex-col items-center justify-center h-full space-y-8">
          ...
          <Button 
            onClick={handleInviteBot}
            className="gradient-bg-orange-yellow text-dark-primary px-8 py-3 rounded-full font-semibold text-lg"
